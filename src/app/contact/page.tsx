    ...
    <main className="bg-white">
      ...
      <section className="bg-gradient-to-b from-[#f9a8c9] to-white py-16 px-6 md:px-12 lg:px-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Have questions about our services? We'd love to hear from you. Contact us and we'll respond as soon as possible.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg border border-gray-100 p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <a href="mailto:support@gynocare.com" className="text-[#c94d8a] font-semibold hover:underline">
            ...
            <div className="bg-white rounded-lg border border-gray-100 p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <a href="tel:+1234567890" className="text-[#c94d8a] font-semibold hover:underline">
                +1 (234) 567-890
              </a>
            </div>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-20 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-100 p-8 shadow-sm">
            {submitMessage && (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={index} className="group border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-gray-900">
                  {faq.q}
                  <span className="transform group-open:rotate-180 transition-transform text-[#c94d8a]">▼</span>
                </summary>
