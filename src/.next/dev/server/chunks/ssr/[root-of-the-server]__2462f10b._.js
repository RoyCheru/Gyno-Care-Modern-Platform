...
;
const metadata = {
    title: "Gynocare - Online Gynaecological Consultations",
    description: "Access compassionate gynaecological care at your fingertips. Book online consultations with certified specialists.",
    generator: "v0.app",
    icons: {
        icon: [
            {
